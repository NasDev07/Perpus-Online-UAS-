...
Route::get('/syarat', [DinamisController::class, 'syarat']);

// crud buku

Route::get('/mahasiswa', [DinamisController::class, 'index']);
Route::get('/mahasiswa/create', [DinamisController::class, 'create']);
Route::post('/mahasiswa/store', [MahasiswaController::class, 'store']);
Route::get('/mahasiswa/{id}/edit', [DinamisController::class, 'edit']);
Route::post('/mahasiswa/{id}/update', [DinamisController::class, 'update']);
Route::get('/mahasiswa/{id}/delete', [DinamisController::class, 'destroy']);
